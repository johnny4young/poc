...
const listAllBitbrewTrackers = [
    ...
    },
    {
      "brokers": [
        ...
        {
          "imei": "015169002316210",
          "type": "DanlawTcp"
        }
      ],
      "createdAt": "2021-09-07T13:42:22.346Z",
      "deviceId": "0110285171",
      "enabled": true,
      "tags": [
        {
    ...
    },
    {
      "brokers": [
        ...
        {
          "imei": "015169002317267",
          "type": "DanlawTcp"
        }
      ],
      "createdAt": "2021-09-07T14:08:28.506Z",
      "deviceId": "0072086121",
      "enabled": true,
      "tags": [
        {
    ...
    },
    {
      "brokers": [
        ...
        {
          "imei": "015169000881199",
          "type": "DanlawTcp"
        }
      ],
      "createdAt": "2021-09-07T21:53:30.686Z",
      "deviceId": "0102986100",
      "enabled": true,
      "tags": [
        {
...
async function main() {
  ...
  const listTrackersMJauto = listAllBitbrewTrackers.filter( tracker => {
    return tracker.tags.find(item => item.name === 'dealers/mjauto')
